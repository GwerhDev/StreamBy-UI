...
import { NodeContext } from '../NodeViewer/nodePalette';
...
export const TemplatePicker = ({ context, onSelect }: Props) => {
  const templates = WORKFLOW_TEMPLATES.filter(t => t.contexts.includes(context));
